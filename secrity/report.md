...
.you-badge { font-family: var(--mono); font-size: 10px; padding: 2px 8px; background: var(--green-pale); color: var(--green); border: 1px solid rgba(11,110,79,0.2); }
...
<div class="cover">
  ...
  <div class="cover-content">
    <div class="cover-logo">
      <div class="cover-logo-mark">SG</div>
      <div class="cover-logo-text">ShieldGCC</div>
    </div>
    <div class="cover-eyebrow">Confidential Risk Assessment Report</div>
    <h1 class="cover-headline">Your GCC carries <em>three open wounds</em> that your AI roadmap hasn't closed.</h1>
    <p class="cover-sub">This report maps your India GCC's AI security exposure across the three pillars that regulators, auditors, and adversaries are already prioritising. It is based on your responses to the ShieldGCC risk scan.</p>
    <div class="cover-meta">
      <div class="cover-meta-item">
        <div class="cover-meta-label">Prepared for</div>
        <div class="cover-meta-val" id="meta-name">{{FIRST_NAME}} {{LAST_NAME}}</div>
      </div>
      <div class="cover-meta-item">
        <div class="cover-meta-label">Role</div>
        <div class="cover-meta-val" id="meta-role">{{ROLE}}</div>
      </div>
      <div class="cover-meta-item">
        <div class="cover-meta-label">Organisation</div>
        <div class="cover-meta-val" id="meta-company">{{COMPANY}}</div>
      </div>
      <div class="cover-meta-item">
        <div class="cover-meta-label">Report date</div>
        <div class="cover-meta-val" id="meta-date">{{DATE}}</div>
      </div>
    </div>
  </div>
</div>
...
<div class="score-band">
  <div class="score-main">
    <div class="score-num critical" id="score-display">{{SCORE}}</div>
    <div class="score-label">Risk Score</div>
  </div>
  <div class="score-gauge">
    <div class="gauge-track">
      <div class="gauge-fill" id="gauge-fill" style="width: {{SCORE}}%"></div>
    </div>
  ...
  <div class="score-tier">
    <div class="tier-badge critical" id="tier-badge">{{TIER_LABEL}}</div>
    <div class="tier-desc" id="tier-desc">{{TIER_DESC}}</div>
  </div>
</div>
  ...
  <div class="page-wrap">
    ...
    <div class="impact-grid">
      <div class="impact-cell">
        <div class="impact-num">{{SCORE}}</div>
        <div class="impact-label" style="color:rgba(255,255,255,0.45)">Your composite risk score out of 100. Above 70 indicates critical exposure requiring immediate architectural intervention.</div>
      </div>
      <div class="impact-cell">
        <div class="impact-stat-label">Highest risk pillar</div>
        <div class="impact-stat-val" id="top-pillar-cell">{{TOP_PILLAR}}</div>
      </div>
      <div class="impact-cell">
        <div class="impact-stat-label">Regulatory exposure</div>
        <div class="impact-stat-val">DPDP Act enforcement is active. Your current AI data flow posture may not withstand regulatory scrutiny without documented controls.</div>
      </div>
      <div class="impact-cell">
  ...
  <div class="page-wrap">
    ...
    <div class="pillar-stack" id="pillar-stack">
      ...
      <div class="pillar-row">
        <div class="pillar-accent critical"></div>
        <div class="pillar-body">
          <div class="pillar-header">
            <div class="pillar-name">&#128274; AI Sovereignty &amp; Data Leakage</div>
            <div class="pillar-tag critical" id="p1-tag">{{P1_LABEL}}</div>
          </div>
          <div class="pillar-fear">"If my India team uses ChatGPT to write code, where does my IP actually go? Can the vendor train on it?"</div>
          <div class="pillar-finding" id="p1-finding">{{P1_FINDING}}</div>
          <div class="pillar-score-row">
            <div class="pillar-score-bar-bg"><div class="pillar-score-bar critical" id="p1-bar" style="width: {{P1_SCORE}}%"></div></div>
            <div class="pillar-score-num critical" id="p1-score">{{P1_SCORE}}</div>
          </div>
      ...
      <!-- PILLAR 2 — AGENTIC -->
      <div class="pillar-row">
        <div class="pillar-accent moderate" id="p2-accent"></div>
        <div class="pillar-body">
          <div class="pillar-header">
          ...
          <div class="pillar-score-row">
            ...
            <div class="pillar-score-num moderate" id="p2-score">{{P2_SCORE}}</div>
          </div>
      ...
      <div class="pillar-row">
        <div class="pillar-accent moderate" id="p3-accent"></div>
        <div class="pillar-body">
          <div class="pillar-header">
            <div class="pillar-name">&#128737; Post-Quantum &amp; AI Cyber Defense</div>
            <div class="pillar-tag moderate" id="p3-tag">{{P3_LABEL}}</div>
          </div>
          <div class="pillar-fear">"Hackers are using AI to find vulnerabilities faster than we can patch them. And in five years, a quantum computer could decrypt everything we encrypted today."</div>
          <div class="pillar-finding" id="p3-finding">{{P3_FINDING}}</div>
          <div class="pillar-score-row">
            <div class="pillar-score-bar-bg"><div class="pillar-score-bar moderate" id="p3-bar" style="width: {{P3_SCORE}}%"></div></div>
            <div class="pillar-score-num moderate" id="p3-score">{{P3_SCORE}}</div>
          </div>
      ...
      <div class="roadmap-step">
        ...
        <div class="step-content">
          ...
          <div class="step-services">
            ...
            <span class="step-chip">Acceptable Use Policy</span>
            <span class="step-chip">DPDP Gap Assessment</span>
          </div>
        </div>
      </div>
      ...
      <div class="roadmap-step">
        ...
        <div class="step-content">
          ...
          <div class="step-services">
            ...
            <span class="step-chip">Agentic Identity Framework</span>
            <span class="step-chip">HITL Audit Trails</span>
          </div>
        </div>
      </div>
      ...
      <div class="roadmap-step">
        ...
        <div class="step-content">
          ...
          <div class="step-services">
            ...
            <span class="step-chip">PQC Readiness Assessment</span>
            <span class="step-chip">Crypto-Agile Migration</span>
            <span class="step-chip">NIST PQC Roadmap</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="page-wrap">
    ...
    <div class="intel-cards" style="margin-bottom: 28px;">
      <div class="intel-card">
        <div class="intel-card-label">GCCs with formal AI governance</div>
        <div class="intel-card-stat">27%</div>
        <div class="intel-card-desc">Only 1 in 4 India GCCs has a documented AI governance framework with an assigned owner. The other 73% rely on informal policies that would not survive an audit.</div>
      </div>
      <div class="intel-card">
      ...
      <div class="intel-card">
        ...
        <div class="intel-card-stat">18%</div>
        <div class="intel-card-desc">Post-quantum migration is a multi-year programme. The 18% that started in 2025-26 will complete ahead of the regulatory mandate. The majority will not.</div>
      </div>
      <div class="intel-card">
        <div class="intel-card-label">Avg time to detect shadow AI usage</div>
        <div class="intel-card-stat">94 days</div>
        <div class="intel-card-desc">The median GCC takes over 90 days to detect that developers have introduced an unauthorised AI tool. In that window, the IP damage is already done.</div>
      </div>
    </div>
      ...
      <table class="benchmark-table">
        ...
        <tbody>
          <tr>
            ...
            <td id="bm-policy">{{BM_POLICY}}</td>
            <td><div class="bm-bar-bg"><div class="bm-bar" style="width:41%; background: var(--amber);"></div></div></td>
          </tr>
          <tr>
            <td><strong>Private / On-Prem LLM</strong></td>
            <td>19% deployed</td>
            <td id="bm-llm">{{BM_LLM}}</td>
            <td><div class="bm-bar-bg"><div class="bm-bar" style="width:19%; background: var(--red);"></div></div></td>
          </tr>
          <tr>
            <td><strong>Agentic Identity Framework</strong></td>
            <td>11% operational</td>
            <td id="bm-agent">{{BM_AGENT}}</td>
            <td><div class="bm-bar-bg"><div class="bm-bar" style="width:11%; background: var(--red);"></div></div></td>
          </tr>
          <tr>
            <td><strong>PQC Readiness Assessment</strong></td>
            <td>18% completed</td>
            <td id="bm-pqc">{{BM_PQC}}</td>
            <td><div class="bm-bar-bg"><div class="bm-bar" style="width:18%; background: var(--red);"></div></div></td>
          </tr>
          <tr>
...
<div class="cta-block reveal">
  <div class="page-wrap" style="padding:0;">
    ...
    <div class="cta-options">
      ...
      <a class="cta-option" href="#" onclick="return false;">
        <div class="cta-option-icon">&#128196;</div>
        <div class="cta-option-title">Download the Full GCC AI Risk Framework</div>
        <div class="cta-option-desc">Our 40-page technical framework covers all three pillars with architecture diagrams, vendor evaluation criteria, and implementation checklists for each.</div>
      </a>
      <a class="cta-option" href="#" onclick="return false;">
        <div class="cta-option-icon">&#128101;</div>
        <div class="cta-option-title">Share This Report With Your Team</div>
        <div class="cta-option-desc">Forward this report to your CISO, CTO, or GCC head. A shared risk view accelerates internal alignment and shortens the path to a governance decision.</div>
      </a>
    </div>

    <a class="cta-primary-btn" href="https://calendly.com/shieldgcc/strategy" target="_blank">Book My Strategy Call →</a>

    <div class="cta-urgency">
      <div class="cta-urgency-text">&#9888; We reviewed 340 GCC risk profiles in Q1 2026. The organisations that acted on their highest-risk pillar within 30 days of assessment reduced their measured exposure by an average of 61%. The ones that filed this report and moved on did not. The window to act before your next board AI risk review is now.</div>
    </div>

    <div class="expect-steps" style="margin-top: 40px;">
      <div class="expect-step">
        <div class="expect-num">01</div>
        <div class="expect-title">You book the call</div>
        <div class="expect-desc">A 30-minute slot with a GCC security architect. Bring your biggest question. We bring the answers.</div>
      </div>
      <div class="expect-step">
      ...
      <div class="expect-step">
        ...
        <div class="expect-title">You decide what happens next</div>
        <div class="expect-desc">If there is a fit, we scope a pilot engagement. If there is not, we will tell you honestly and point you to the right resource.</div>
      </div>
    </div>
  </div>
</div>
...
const reportData = {
  ...
  score:        78,
  p1Score:      90,  // AI Sovereignty
  p2Score:      85,  // Agentic Accountability
  p3Score:      62,  // Post-Quantum (avg of Q3+Q4)
};
...
function renderReport() {
  ...
  const p1 = getPillarLabel(d.p1Score);
  const p2 = getPillarLabel(d.p2Score);
  const p3 = getPillarLabel(d.p3Score);

  // Meta
  document.getElementById('meta-name').textContent = d.firstName + ' ' + d.lastName;
  document.getElementById('meta-role').textContent = d.role;
  document.getElementById('meta-company').textContent = d.company;
  document.getElementById('meta-date').textContent = new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' });

  // Score
  document.getElementById('score-display').textContent = d.score;
  document.getElementById('score-display').className = 'score-num ' + tier.cls;
  document.getElementById('gauge-fill').style.width = d.score + '%';
  document.getElementById('tier-badge').textContent = tier.label;
  document.getElementById('tier-badge').className = 'tier-badge ' + tier.cls;
  ...
  p1El.textContent = p1.label; p1El.className = 'pillar-tag ' + p1.cls;
  document.getElementById('p1-finding').textContent = getFindingText(p1Findings, d.p1Score);
  document.getElementById('p1-bar').style.width = d.p1Score + '%';
  document.getElementById('p1-bar').className = 'pillar-score-bar ' + p1.cls;
  document.getElementById('p1-score').textContent = d.p1Score;
  document.getElementById('p1-score').className = 'pillar-score-num ' + p1.cls;

  const p2El = document.getElementById('p2-tag');
  p2El.textContent = p2.label; p2El.className = 'pillar-tag ' + p2.cls;
  document.getElementById('p2-accent').className = 'pillar-accent ' + p2.cls;
  document.getElementById('p2-finding').textContent = getFindingText(p2Findings, d.p2Score);
  document.getElementById('p2-bar').style.width = d.p2Score + '%';
  document.getElementById('p2-bar').className = 'pillar-score-bar ' + p2.cls;
  document.getElementById('p2-score').textContent = d.p2Score;
  document.getElementById('p2-score').className = 'pillar-score-num ' + p2.cls;

  const p3El = document.getElementById('p3-tag');
  p3El.textContent = p3.label; p3El.className = 'pillar-tag ' + p3.cls;
  document.getElementById('p3-accent').className = 'pillar-accent ' + p3.cls;
  document.getElementById('p3-finding').textContent = getFindingText(p3Findings, d.p3Score);
  document.getElementById('p3-bar').style.width = d.p3Score + '%';
  document.getElementById('p3-bar').className = 'pillar-score-bar ' + p3.cls;
  document.getElementById('p3-score').textContent = d.p3Score;
...
setTimeout(() => {
  ...
  const finalWidth = reportData.score + '%';
  fill.style.width = '0%';
  requestAnimationFrame(() => { setTimeout(() => { fill.style.width = finalWidth; }, 100); });
}, 200);
</script>
</body>
</html>